...
try:
    # Load page
    driver.get(url)
    time.sleep(5)  # Wait longer for Adobe Stock's dynamic content
...
# Find all image tags with specific attributes for Adobe Stock
img_tags = soup.find_all("img", {"data-asset-type": "image"})
